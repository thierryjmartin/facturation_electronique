...
class TradeTaxType:
    ...
    line_total_basis_amount: Optional[AmountType] = field(
        default=None,
        metadata={
    ...
    allowance_charge_basis_amount: Optional[AmountType] = field(
        default=None,
        metadata={
...
class AdvancePaymentType:
    ...
    invoice_specified_referenced_document: Optional[ReferencedDocumentType] = field(
        default=None,
        metadata={
...
class TradePartyType:
    ...
    role_code: Optional[PartyRoleCodeType] = field(
        default=None,
        metadata={
            "name": "RoleCode",
            "type": "Element",
