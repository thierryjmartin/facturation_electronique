...
if __name__ == '__main__':
	...
	facturx_invoice = FactureFacturX(
		...
		destinataire=Destinataire(
			...
			adresse_postale=AdressePostale(ligne_un="123 Rue du Test", code_postal="75001", nom_ville="Paris")
		),
		fournisseur=Fournisseur(
			id_fournisseur=identifiant_cpro,
			...
			adresse_postale=AdressePostale(ligne_un="456 Avenue du Code", code_postal="69001", nom_ville="Lyon")
		),
		cadre_de_facturation=CadreDeFacturation(
			code_cadre_facturation=CodeCadreFacturation.A1_FACTURE_FOURNISSEUR
		),
